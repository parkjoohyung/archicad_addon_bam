...
typedef enum {
	...
	APIDesignVariantsCreate,
	APIDesignVariantsDeleteModify,
	APIMEPToolElements,
	APIMEPPreferences
} API_TWAccessRights;
...
/** @brief Project library types.
	...
	@remarks The `libraryType` data member in the @ref API_LibraryInfo structure defines the type of the project library, which can be
	- Local Library
	- Embedded Library
	- Built-In Library
...
/** @brief Parameters of the change story settings command.
	...
	Note that story operations 뾢xcept changing the active story?are disabled in teamwork projects.
*/
struct API_StoryCmdType {
...
/** @brief enum class API_LongLatUnitID { @c APILongLatUnit_DecimalDegree, @c APILongLatUnit_DegreeMinSec } ;
	@enum API_LongLatUnitID
	@ingroup GeoLocation
	@since Archicad 26
*/
...
/**	@brief Linetype index for hidden lines&nbsp;
	@var hiddenLineType
*/
